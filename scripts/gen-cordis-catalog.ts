...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  contextComposition: 'context-composition.md',
  ...
  platformShell: 'platform-shell.md',
  projectInsight: 'project-insight.md',
  engineIsolation: 'engine-isolation.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  router: 'client-side interface-typed router service — packages/client/ui-router/README.md owns the API',
...
export const EVENT_SCOPE_PAGE: Record<string, string> = {
  ...
  'plugin-inventory': 'extensions.md',
  'plugin-manager': 'extensions.md',
  'project-insight': 'project-insight.md',
}
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AgentDrive: 'engine-isolation.md',
  ...
  AgentRunRequest: 'engine-isolation.md',
  AgentStatus: 'core.md',
  ...
  ScopeKey: 'scope.md',
  Scoped: 'scope.md',
  EngineDriver: 'engine-isolation.md',
  EngineKind: 'engine-isolation.md',
  ...
  AccountRecord: 'platform-shell.md',
  ApprovalTicket: 'platform-shell.md',
  ApprovalTransition: 'platform-shell.md',
  AssetId: 'platform-shell.md',
  AssetKind: 'platform-shell.md',
  AssetRecord: 'platform-shell.md',
  AuditEvent: 'platform-shell.md',
  BusinessApprovalStatus: 'platform-shell.md',
  CapabilityGate: 'platform-shell.md',
  CapabilityId: 'platform-shell.md',
  CapabilityRecord: 'platform-shell.md',
  ConsumeCapabilityRequest: 'platform-shell.md',
  LineageEdge: 'platform-shell.md',
  Membership: 'platform-shell.md',
  Permission: 'platform-shell.md',
  PublishCapabilityRequest: 'platform-shell.md',
  PublishScenarioRequest: 'platform-shell.md',
  RegisterAssetRequest: 'platform-shell.md',
  ResolveCapabilitiesRequest: 'platform-shell.md',
  ResolvedCapabilitySet: 'platform-shell.md',
  ReviewScope: 'platform-shell.md',
  RoleId: 'platform-shell.md',
  RunHandle: 'engine-isolation.md',
  ScenarioBundle: 'platform-shell.md',
  ScenarioId: 'platform-shell.md',
  SettlementId: 'platform-shell.md',
  SettlementRecord: 'platform-shell.md',
  SettlementStatus: 'platform-shell.md',
  TicketId: 'platform-shell.md',
  UsageRecord: 'platform-shell.md',
  UserId: 'platform-shell.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  EntryOptions: 'loader entry options are owned by vendor/loader (vendored upstream)',
  ComposeRow: 'preset compose row is owned by packages/preset/agent-presets/src/index.ts',
  AssemblePresetRequest: 'platform shell assemble request is owned by packages/experimental/platform-shell/src/types.ts',
  AssembledPreset: 'platform shell assembled preset is owned by packages/experimental/platform-shell/src/types.ts',
  FlowGraph: 'flow graph contract is owned by packages/workflow/flow/src/types.ts',
  FlowSummary: 'flow summary record is owned by packages/workflow/flow/src/types.ts',
  FlowRunRequest: 'flow run request is owned by packages/workflow/flow/src/service.ts',
  FlowRunHandle: 'flow run handle is owned by packages/workflow/flow/src/service.ts',
  FlowRunIdType: 'flow run identity is owned by packages/workflow/flow/src/types.ts',
  FlowRunSummary: 'flow run summary is owned by packages/workflow/flow/src/types.ts',
  FlowRunSnapshot: 'flow run snapshot is owned by packages/workflow/flow/src/types.ts',
  ContextComposition: 'context composition snapshot is owned by packages/session/context-composition/src/types.ts',
  PluginInventorySnapshot: 'plugin inventory snapshot is owned by packages/host/plugin-inventory/src/types.ts',
  ProjectInsightReadResult: 'project insight read result is owned by packages/insight/project-insight/src/service.ts',
  ProjectInsightScanResult: 'project insight scan result is owned by packages/insight/project-insight/src/service.ts',
}
