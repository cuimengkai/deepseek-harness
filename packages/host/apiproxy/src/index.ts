...
export class ApiProxyService extends Service implements ApiProxy {
  ...
  readonly projectInsight: ApiProxy['projectInsight']
  readonly contextComposition: ApiProxy['contextComposition']
  readonly flow: ApiProxy['flow']
  ...
  constructor(ctx: Context, config: Config) {
    ...
    this.projectInsight = api.projectInsight
    this.contextComposition = api.contextComposition
    this.flow = api.flow
