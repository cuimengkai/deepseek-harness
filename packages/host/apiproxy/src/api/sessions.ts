...
import type { ContentBlock, ModelKind, ModelModality } from '@deepseek-ai/dsh-llm/types'
...
export interface ModelCatalogModel {
  ...
  /** Model roles this entry can serve; absence means the adapter did not declare them. */
