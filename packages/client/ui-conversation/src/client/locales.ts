...
export const zh = {
  ...
  'placeholder.hero': '今天帮你做些什么？@ 引用对话文件，/ 调用技能与指令',
  'placeholder.workspace': '选择一个工作区开始',
  'workspace.connectError': '工作区连接失败：{message}',
  'placeholder.steerQueue': 'Cmd/Ctrl+Enter 插话发送全部排队消息',
  'input.commands': '指令',
  'input.plus': '添加',
  'input.plus.file': '添加文件',
  'input.plus.mode': '模式',
  'input.plus.mode.hint': '当前为默认模式，可高效执行并完成任务。',
  'input.plus.mode.plan': '计划 Plan',
  'input.plus.expert': '专家',
  'input.plus.skills': '技能',
  'input.stop': '停止生成',
  'input.send': '发送消息',
...
export const en = {
  ...
  'placeholder.hero': 'What can I help you with today? @ reference files, / skills and commands',
  'placeholder.workspace': 'Choose a workspace to start',
  'workspace.connectError': 'Workspace connection failed: {message}',
  'placeholder.steerQueue': 'Cmd/Ctrl+Enter steers all queued messages',
  'input.commands': 'Commands',
  'input.plus': 'Add',
  'input.plus.file': 'Add file',
  'input.plus.mode': 'Mode',
  'input.plus.mode.hint': 'Default mode — execute and complete tasks efficiently.',
  'input.plus.mode.plan': 'Plan',
  'input.plus.expert': 'Experts',
  'input.plus.skills': 'Skills',
  ...
  'access.fullLabel': 'Full access',
  'hero.headline': '{brand}, I can help',
