...
// PagesSnapshot: the page-projection snapshot the frame and page consumers
// select against. The frame components and the store factory stay internal.
export { LayoutController } from './service.ts'
export type { ILayout } from './service.ts'
export type { PagesSnapshot } from './pages.ts'
