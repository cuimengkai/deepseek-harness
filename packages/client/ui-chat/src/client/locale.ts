...
export const zh = {
  ...
  'results.title': '结果',
  'results.close': '关闭结果',
  'results.tabsLabel': '结果分区',
  'results.tab.artifacts': '产物',
  'results.tab.changes': '变更',
  'results.tab.files': '文件',
  'results.tab.inspect': '检视',
  'results.artifactsEmpty': '本会话尚无产物',
  'results.changesEmpty': '本会话尚无文件变更',
  'results.filesEmpty': '本会话尚无已触及的文件',
  'results.cwd': '工作区 {path}',
  'results.openFile': '打开 {path}',
  'results.changed': '已修改',
  'results.toggle': '结果',
  'results.toggleOpen': '打开结果',
  'results.toggleClose': '关闭结果',
...
export const en = {
  ...
  'results.tabsLabel': 'Results sections',
  'results.tab.artifacts': 'Artifacts',
  'results.tab.changes': 'Changes',
  'results.tab.files': 'Files',
  'results.tab.inspect': 'Inspect',
  'results.artifactsEmpty': 'No artifacts in this session yet',
  'results.changesEmpty': 'No file changes in this session yet',
  'results.filesEmpty': 'No touched files in this session yet',
  'results.cwd': 'Workspace {path}',
  'results.openFile': 'Open {path}',
  'results.changed': 'Modified',
  'results.toggle': 'Results',
  'results.toggleOpen': 'Open results',
  'results.toggleClose': 'Close results',
