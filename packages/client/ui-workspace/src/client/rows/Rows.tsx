 ...
 * @param props.onDelete - open the delete-confirmation dialog (id + display title).
...
export function SessionNodeItem({ node, currentId, now, onOpen, onRename, onFork, onArchive, onDelete, drag, flat = false, t }: {
  ...
  onDelete: (id: SessionNode['id'], displayTitle: string) => void
  ...
  // confirmation dialog. Delete physically removes the log and the subagent
  // tree, so it carries the danger styling and routes through the browser's
