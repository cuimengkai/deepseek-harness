...
export const zh = {
  ...
  'delete.sessionDesc': '将永久删除“{name}”及其全部消息记录与子代理会话，此操作无法撤销。',
...
export const en = {
  ...
  'delete.sessionDesc': 'This permanently deletes “{name}” with its full message log and subagent sessions. This cannot be undone.',
