...
/** The kind's display-copy key, resolved per row. */
function kindKey(kind: ModelKind): AgentPresetSettingsKey {
  switch (kind) {
    case 'text': return 'modelKindText'
    case 'image': return 'modelKindImage'
    case 'audio': return 'modelKindAudio'
    case 'embedding': return 'modelKindEmbedding'
  }
}
