...
import type { ContentBlock, ModelKind } from '@deepseek-ai/dsh-llm/types'
...
export interface ModelCatalogModel {
  ...
  readonly name: string
  readonly description?: string
  /** Model roles this entry can serve; absent means unknown, and selectors treat it as text-only. */
