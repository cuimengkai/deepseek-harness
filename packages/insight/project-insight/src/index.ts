 ...
 * session's workspace into a versioned `.dsh/insight/` document — module
 * topology, component dependencies, components, tech stack, prompts, and
...
export {
  PROJECT_INSIGHT_FORMAT_VERSION, MAX_DOC_BYTES, MAX_EDGES,
...
export { PROJECT_INSIGHT_DIR_REL, PROJECT_INSIGHT_META_REL, readDocument, writeDocument } from './fingerprint.ts'
