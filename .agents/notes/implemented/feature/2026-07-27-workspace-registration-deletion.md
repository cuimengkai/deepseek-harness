...
The menu, Modal, and buttons retain their existing structure and design tokens. Session deletion later grew its own lifecycle ([[2026-08-19-session-deletion]]) and its row action reuses this confirmation pattern ([[2026-08-26-session-delete-confirmation]]).
