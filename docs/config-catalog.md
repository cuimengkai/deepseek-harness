...
Source: [`packages/core/agent-loop/src/index.ts:284`](../packages/core/agent-loop/src/index.ts)
...
Source: [`packages/preset/agent-modes/src/mode.ts:50`](../packages/preset/agent-modes/src/mode.ts)
...
Source: [`packages/mcp/connector-registry/src/index.ts:50`](../packages/mcp/connector-registry/src/index.ts)
...
Source: [`packages/host/plugin-manager/src/index.ts:83`](../packages/host/plugin-manager/src/index.ts)
...
Depends on: [`ModelKind`](../packages/llm/llm/src/index.ts) · [`ModelModality`](../packages/llm/llm/src/index.ts) · [`RetryPolicyConfig`](../packages/llm/llm/src/index.ts)
...
Source: [`packages/preset/project-bundle/src/index.ts:33`](../packages/preset/project-bundle/src/index.ts)
...
Source: [`packages/session/session-projection-cache/src/index.ts:49`](../packages/session/session-projection-cache/src/index.ts)
...
Requires: `subagents` · `web` · `codeRuntime`
...
- `@deepseek-ai/dsh-command-session-delete` — requires `commands` · `sessionDeletion` ([`packages/session/command-session-delete/src/index.ts`](../packages/session/command-session-delete/src/index.ts))
...
- `@deepseek-ai/dsh-session-deletion` — requires `storageDomain` · `sessions` · `sessionPersistence` ([`packages/session/session-deletion/src/index.ts`](../packages/session/session-deletion/src/index.ts))
