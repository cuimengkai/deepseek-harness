...
flowchart TD
  ...
  subgraph group_client["packages/client"]
    ...
    pkg_client_ui_flow_editor["client-ui-flow-editor"]
    ...
    pkg_client_ui_project_insight["client-ui-project-insight"]
    pkg_client_ui_reference["client-ui-reference"]
    pkg_client_ui_renderer["client-ui-renderer"]
    pkg_client_ui_router["client-ui-router"]
  ...
  subgraph group_insight["packages/insight"]
  ...
  pkg_client_ui_router --> pkg_invariants
  ...
  pkg_host_plugin_manager --> pkg_brand
  ...
  pkg_session_deletion --> pkg_session_projection_cache
  pkg_session_deletion --> pkg_storage_domain
  pkg_session_deletion --> pkg_workspace
  ...
  pkg_flow --> pkg_agent
  pkg_flow --> pkg_brand
  pkg_flow --> pkg_invariants
  pkg_flow --> pkg_llm
  pkg_flow --> pkg_workflow
  ...
  pkg_client_ui_flow_editor --> pkg_flow
  pkg_client_ui_flow_editor --> pkg_invariants
  ...
  pkg_experimental_platform_shell --> pkg_brand
  pkg_experimental_platform_shell --> pkg_invariants
  pkg_experimental_platform_shell --> pkg_llm
  pkg_experimental_platform_shell --> pkg_session
  pkg_experimental_platform_shell --> pkg_tools
  ...
  pkg_command_session_delete --> pkg_commands
  pkg_command_session_delete --> pkg_invariants
  pkg_command_session_delete --> pkg_session
  pkg_command_session_delete --> pkg_session_deletion
  ...
  pkg_experimental_engine_isolation --> pkg_experimental_platform_shell
  pkg_experimental_engine_isolation --> pkg_invariants
  pkg_experimental_engine_isolation --> pkg_session
  pkg_experimental_engine_isolation --> pkg_subprocess
  ...
  pkg_project_insight --> pkg_agent_presets
  pkg_project_insight --> pkg_atomic_write
  pkg_project_insight --> pkg_invariants
  pkg_project_insight --> pkg_llm
  pkg_project_insight --> pkg_session
  pkg_project_insight --> pkg_tools
  pkg_context_composition --> pkg_compaction
  pkg_context_composition --> pkg_invariants
  pkg_context_composition --> pkg_llm
  pkg_context_composition --> pkg_session
  pkg_context_composition --> pkg_token_meter
  ...
  pkg_client_ui_project_insight --> pkg_api_remotes
  pkg_client_ui_project_insight --> pkg_client_connection
  pkg_client_ui_project_insight --> pkg_client_locale
  pkg_client_ui_project_insight --> pkg_client_store
  pkg_client_ui_project_insight --> pkg_client_ui_conversation
  pkg_client_ui_project_insight --> pkg_invariants
  pkg_client_ui_project_insight --> pkg_session
...
| [`client-ui-router`](../packages/client/ui-router) | `client` | [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`host-plugin-manager`](../packages/host/plugin-manager) | `host` | [`brand`](../packages/util/brand), [`invariants`](../packages/runtime-diagnostics/invariants), [`typert-protocol`](../packages/typert/protocol) |
...
| [`session-deletion`](../packages/session/session-deletion) | `session` | [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`session-projection-cache`](../packages/session/session-projection-cache), [`storage-domain`](../packages/storage/storage-domain), [`workspace`](../packages/workspace/workspace) |
...
| [`flow`](../packages/workflow/flow) | `workflow` | [`agent`](../packages/core/agent), [`brand`](../packages/util/brand), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`workflow`](../packages/workflow/workflow) |
...
| [`client-ui-flow-editor`](../packages/client/ui-flow-editor) | `client` | [`flow`](../packages/workflow/flow), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`experimental-platform-shell`](../packages/experimental/platform-shell) | `experimental` | [`brand`](../packages/util/brand), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`tools`](../packages/core/tools) |
...
| [`command-session-delete`](../packages/session/command-session-delete) | `session` | [`commands`](../packages/interaction/commands), [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`session-deletion`](../packages/session/session-deletion) |
...
| [`experimental-engine-isolation`](../packages/experimental/engine-isolation) | `experimental` | [`experimental-platform-shell`](../packages/experimental/platform-shell), [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`subprocess`](../packages/subprocess/subprocess) |
...
| [`project-insight`](../packages/insight/project-insight) | `insight` | [`agent-presets`](../packages/preset/agent-presets), [`atomic-write`](../packages/util/atomic-write), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`tools`](../packages/core/tools) |
| [`context-composition`](../packages/session/context-composition) | `session` | [`compaction`](../packages/compaction/compaction), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`token-meter`](../packages/llm/token-meter) |
...
| [`client-ui-context`](../packages/client/ui-context) | `client` | [`api-remotes`](../packages/api/remotes), [`client-connection`](../packages/client/connection), [`client-locale`](../packages/client/locale), [`client-store`](../packages/client/store), [`client-ui-conversation`](../packages/client/ui-conversation), [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session) |
...
| [`client-ui-project-insight`](../packages/client/ui-project-insight) | `client` | [`api-remotes`](../packages/api/remotes), [`client-connection`](../packages/client/connection), [`client-locale`](../packages/client/locale), [`client-store`](../packages/client/store), [`client-ui-conversation`](../packages/client/ui-conversation), [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session) |
